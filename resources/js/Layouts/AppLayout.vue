...
<template>
  <div>
    ...
    <div class="bg-white text-slate-800 antialiased">
      <!-- Modern Navbar -->
      <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" :class="navbarClasses">
        <div class="container">
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex-shrink-0">
              <Link :href="route('landing')" class="flex items-center space-x-3 group">
                <div class="relative">
                  <!-- Government Crest -->
                  <div v-if="!isScrolled"
                    class="h-9 w-9 rounded-full bg-white/10 border-2 border-white/20 flex items-center justify-center mr-1">
                  ...
                  <div v-else
                    class="h-10 w-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                    <span class="text-white font-bold text-xs">CSIRT</span>
                  </div>
                </div>
                <div :class="!isScrolled && isMobile ? 'hidden' : 'block'">
                  <h2 class="text-xl font-bold transition-colors duration-200" :class="navTextClasses.logo">CSIRT
                    Bojonegoro</h2>
            ...
            <div class="hidden lg:flex items-center space-x-1">
              ...
              <div class="flex items-center space-x-1 pr-2">
                <Link :href="route('landing')"
                  ...
                  <div
                    class="absolute inset-0 rounded-lg bg-gradient-to-r from-indigo-500 to-blue-600 opacity-0 group-hover:opacity-10 transition-opacity duration-200">
                  </div>
                </Link>
            ...
            <div class="flex lg:hidden">
              <button @click="isMenuOpen = !isMenuOpen" type="button"
                ...
                :class="navTextClasses.mobile" aria-controls="mobile-menu" aria-expanded="false">
                <span class="sr-only">Buka menu</span>
                <svg class="h-5 w-5 transition-transform duration-200" :class="isMenuOpen ? 'rotate-90' : ''"
        ...
        <div v-show="isMenuOpen" class="lg:hidden bg-white/95 backdrop-blur-md border-t border-slate-200/50"
          id="mobile-menu">
            ...
            <div class="pt-4 mt-4 border-t border-slate-200">
              <Link :href="route('incident.create')"
                ...
                <svg viewBox="0 0 24 24" fill="currentColor"
                  class="w-4 h-4 mr-2 icon icon-tabler icons-tabler-filled icon-tabler-alert-triangle">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-1">
              <div class="flex items-center space-x-3 mb-4">
                <div
                  class="h-10 w-10 px-1 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                  <span class="text-white font-bold text-xs">CSIRT</span>
                </div>
                <div>
              ...
              <p class="text-slate-400 leading-relaxed mb-4">
                Tim Respons Insiden Keamanan Siber Pemerintah Kabupaten Bojonegoro yang berkomitmen melindungi aset
                digital pemerintahan.
              </p>
              <Link :href="isLoggedIn ? route('admin.dashboard') : route('login')" class="flex items-center group">
                <IconLayoutBoard v-if="isLoggedIn" size="14"
                  class="mr-2 text-slate-400 group-hover:text-blue-400 transition-colors duration-200" />
                <IconLogin v-else size="14"
                  class="mr-2 text-slate-400 group-hover:text-blue-400 transition-colors duration-200" />
                <span class="text-slate-400 hover:text-white transition-colors duration-200">{{ isLoggedIn ? 'Dashboard'
                  : 'Login' }}</span>
              </Link>
            </div>
                ...
                <ul class="space-y-1">
                  <li>
                    <Link :href="route('landing')"
                      ...
                      <IconHome size="14"
                        class="mr-2 text-slate-400 group-hover:text-indigo-400 transition-colors duration-200" />
                      Beranda
                    </Link>
                  </li>
                  <li>
            ...
            <div>
              ...
              <div class="space-y-3">
                <div class="flex items-start">
                  ...
                  <div>
                    <p class="text-slate-400 font-medium">{{ contact.phone }}</p>
                    <p class="text-slate-500 text-sm">24/7 Emergency</p>
                  </div>
                </div>
                <div class="flex items-start">
                  <svg class="h-4 w-4 mt-1.5 mr-2 text-indigo-400 flex-shrink-0" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
          ...
          <div class="mt-8 sm:mt-12 pt-8 border-t border-slate-800">
            <div class="flex flex-col md:flex-row justify-between items-center">
              <p class="text-slate-400">
                ...
                <a href="https://bojonegorokab.go.id/" target="_blank"
                  class="hover:text-blue-600 transition-colors duration-200">Pemerintah Kabupaten Bojonegoro</a>. All
                rights reserved.
              </p>
              <p class="text-slate-500 mt-2 md:mt-0">
                Dikelola oleh <a href="https://dinkominfo.bojonegorokab.go.id/" target="_blank"
                  class="hover:text-blue-600 transition-colors duration-200">Diskominfo Bojonegoro</a>
              </p>
            </div>
          </div>
        </div>
