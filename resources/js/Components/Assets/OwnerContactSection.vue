...
<template>
  ...
  >
    <h3 class="font-semibold text-slate-800">Penempatan & Kepemilikan</h3>
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <Button
          ...
          size="small"
          :severity="
            modelValue.owner_contact_type === 'manual' ? 'primary' : 'secondary'
          "
          :variant="
            modelValue.owner_contact_type === 'manual' ? undefined : 'outlined'
          "
    ...
    <div v-if="modelValue.owner_contact_type === 'auto'">
      ...
      >
        <p class="font-medium text-slate-700">{{ ownerOrg.it_contact_name }}</p>
