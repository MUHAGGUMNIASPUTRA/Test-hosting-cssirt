...
export function useParticles() {
  ...
  const loginParticlesOptions = ref({
    ...
    particles: {
      ...
      shape: { type: ["circle", "triangle", "polygon"], options: { polygon: { sides: 6 } } },
      opacity: {
        value: 0.2,
      ...
      links: {
        enable: true, distance: 120, color: "#3B82F6", opacity: 0.15, width: 1,
        triangles: { enable: true, color: "#60A5FA", opacity: 0.05 }
      },
      move: {
        enable: true, speed: 1.2, direction: "none", random: true, straight: false,
    ...
    responsive: [
      {
        ...
        options: {
          ...
          interactivity: {
            modes: { grab: { distance: 100 }, bubble: { distance: 120, size: 6 } }
          }
        }
      }
    ],
