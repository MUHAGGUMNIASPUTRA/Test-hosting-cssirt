                    ...
                    <div>
                      ...
                      <div class="mt-6">
                        <label for="attachment" class="block font-semibold text-slate-700 mb-2">
                          Lampiran Bukti <span class="text-slate-500 font-normal">(Opsional, maksimal 2MB)</span>
                        </label>
                        <FileUpload
                          ref="uploader"
                          name="attachment"
                        ...
                        >
                          ...
                          <template #empty>
                            <div class="flex flex-col items-center justify-center py-6 px-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-600 transition-colors cursor-pointer"
                              ...
                              <p class="text-sm sm:text-base text-slate-500">Format: JPG, PNG, PDF, ZIP, DOC (Maks. 2MB)</p>
                            </div>
                          </template>
                        </FileUpload>
