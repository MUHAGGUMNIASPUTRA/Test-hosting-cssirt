...
const {
  ...
  clearFilters,
  hasActiveFilters,
} = useAdminTable(paginatedData, 'admin.faqs.index', {
  search: searchQuery,
...
const stats = computed(() => {
  ...
  return {
    ...
    categoriesCount: new Set(
      allData.filter((f) => f.category).map((f) => f.category),
    ).size,
  }
})
      ...
      >
        <template #empty>
          <div class="py-12 text-center">
            <IconHelp class="mx-auto mb-4 text-slate-300" size="30" />
            ...
            <p class="mt-1 text-sm text-slate-400">
              {{
                hasActiveFilters
                  ...
                  : 'FAQ yang dibuat akan muncul di sini'
              }}
            </p>
          </div>
        </template>
        ...
        <Column header="FAQ" class="min-w-80">
          <template #body="{ data }">
            <div class="min-w-0 flex-1">
              <h3 class="mb-1 line-clamp-2 font-medium text-slate-700">
                {{ data.question }}
              </h3>
              ...
              <div
                class="mt-1 flex items-center gap-1 text-xs text-slate-500 lg:hidden"
              >
              ...
              >
                ...
                <div>
                  ...
                  <div class="mt-1 flex items-center justify-between">
                    <p v-if="form.errors.answer" class="text-sm text-red-600">
                      {{ form.errors.answer }}
                    </p>
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                      {{
                        form.is_published
                          ? 'FAQ akan ditampilkan di website publik'
                          : 'FAQ disimpan sebagai draft'
                      }}
                    </p>
                  </div>
                </div>
