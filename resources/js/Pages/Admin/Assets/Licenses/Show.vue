...
const securityData = computed(() => ({
  confidentiality:
    props.license?.security_classification?.confidentiality ?? null,
  integrity: props.license?.security_classification?.integrity ?? null,
  availability: props.license?.security_classification?.availability ?? null,
}))
            ...
            <dl class="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <dd class="mt-1 text-sm text-slate-700">
                  <span
                    v-if="
                      lic.owner_contact_type === 'manual' && lic.owner_employee
                    "
                  >
                    {{ lic.owner_employee.name }}
                  </span>
