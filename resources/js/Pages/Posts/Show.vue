              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li v-if="post.categories.length > 0">
                  <div class="flex items-center">
                    ...
                    <Link
                      :href="route('categories.show', post.categories[0].slug)"
        ...
        <div class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <article ref="contentRef" :class="contentClasses">
            ...
            <div v-if="post.image" class="relative mb-8 lg:mb-12">
              ...
              >
                <PostImage :post="post" class="h-full w-full object-cover" />
              </div>
            </div>
            ...
            <div v-if="isDesktop" class="mb-6 flex justify-end">
              <button
                @click="toggleSidebar"
                :disabled="isAnimating"
                class="inline-flex items-center rounded-lg border border-slate-200 bg-slate-100 px-4 py-2 text-slate-700 transition-colors duration-200 hover:bg-slate-200 disabled:opacity-50"
                :title="
          ...
          <aside
            ...
            class="translate-y-10 opacity-0 transition-all duration-300 lg:col-span-4"
            :class="{ 'lg:hidden': isDesktop && !sidebarVisible }"
          >
            <div class="sticky top-8 space-y-6 sm:space-y-8">
              <!-- Rating Section -->
              <div
                class="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50 p-6"
              >
                <!-- <h3 class="text-2xl font-bold text-slate-900 mb-4">Rating Artikel</h3> -->

                <div v-if="userHasRated" class="text-center">
                  <div
                    class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-green-100 sm:h-16 sm:w-16"
                  >
                    <svg
                  ...
                  <p class="mt-2 text-slate-600">
                    Rating Anda membantu pembaca lain
                  </p>
                </div>

                <div v-else class="space-y-2 text-center sm:space-y-4">
              ...
              >
                ...
                <div class="space-y-4 sm:space-y-6">
                  ...
                  >
                    <Link
                      :href="route('posts.show', popularPost.slug)"
                      class="group block"
                    >
                      <div class="flex items-center">
                        <div
