...
return new class extends Migration
{
    ...
    public function down(): void
    {
        DB::table('faqs')->whereIn('question', [
            'Apa itu CSIRT Bojonegoro?',
            'Mengapa CSIRT Bojonegoro dibentuk?',
            'Apa saja tugas utama CSIRT Bojonegoro?',
            'Apakah CSIRT Bojonegoro juga memberikan pelatihan atau sosialisasi?',
            'Siapa saja yang dapat menghubungi CSIRT Bojonegoro?',
            'Apa saja jenis insiden yang dapat dilaporkan ke CSIRT Bojonegoro?',
            'Bagaimana cara melaporkan insiden kepada CSIRT Bojonegoro?',
            'Apakah pelaporan insiden dijamin kerahasiaannya?',
            'Apakah CSIRT Bojonegoro bekerja sama dengan lembaga lain?',
            'Bagaimana saya bisa tahu jika ada serangan siber yang sedang berlangsung?',
            'Apakah CSIRT Bojonegoro hanya menangani serangan dari luar (eksternal)?',
            'Apa perbedaan antara CSIRT Bojonegoro dan Diskominfo Bojonegoro?',
            'Apakah laporan insiden bisa dilakukan secara anonim?',
            'Berapa lama waktu respons dari CSIRT Bojonegoro terhadap laporan insiden?',
            'Apakah CSIRT Bojonegoro juga menangani hoaks digital yang menyebar di masyarakat?',
            'Apakah ada pelaporan insiden yang harus dilakukan secara resmi melalui surat?',
            'Apakah CSIRT Bojonegoro memiliki tim teknis yang turun langsung ke lapangan?',
            'Apa yang harus dilakukan jika terjadi kebocoran data di instansi?',
            'Apakah CSIRT Bojonegoro terhubung dengan sistem pemantauan 24/7?',
            'Apakah ada panduan keamanan siber untuk perangkat daerah?',
        ])->delete();
    }
};
