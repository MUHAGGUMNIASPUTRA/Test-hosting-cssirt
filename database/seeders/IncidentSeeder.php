    ...
    public function run(): void
    {
        ...
        $incidents = [
            ...
            [
                ...
                'incident_type_slug' => 'belum-mengetahui',
            ...
            [
                ...
                'incident_type_slug' => 'bug-hunter',
                'description' => 'Saya menemukan kerentanan dalam aplikasi web yang dimiliki (pariwisata.bojonegorokab.go.id).',
        ...
        foreach ($incidents as $index => $incidentData) {
            ...
            Incident::create([
                'case_id' => 'CSIRT-2025-00-'.str_pad($index + 1, 3, '0', STR_PAD_LEFT),
